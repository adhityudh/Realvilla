...
export const PROPERTY_DETAIL_QUERY = groq`
  *[_type == "property" && propertyCode == $slug && (language == $language || (!defined(language) && $language == "en"))][0] {
    ...
    meta[] {
      ...
      "overviewCategoryOrder": metaKey->category->overviewGroupDisplayOrder,
      "overviewItemsSortOrder": metaKey->category->overviewItemsSortOrder,
      "displayOrder": metaKey->displayOrder,
      "icon": metaKey->icon.asset->url,
      numberValue,
      stringValue,
      booleanValue,
